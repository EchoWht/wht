...
<div class="container black-link-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 id="blog-home" class="page-header">Blog Home
            </h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--div class="col-lg-2 text-center">
                        <p><img style="width: 40px;border-radius: 50%;border: 2px solid darkgreen" alt="<?php echo ($vo["username"]); ?>"
                                src="/Public/images/icon/<?php echo ($vo["username"]); ?>.jpg"
                                onerror="this.src='/Public/images/icon/default.jpg'"/>
                        </p>
                        <p  style="color: #c0c0c0" ><span class="fa fa-clock-o"></span><?php echo ($vo["artdate"]); ?></p>
                    </div-->
                    <div  style="padding:10px;border-bottom:1px solid #f5f5f5;border-radius:5px;margin-bottom:20px">
							<h4>
								<a href="<?php echo U('/Home/Blog/readMore');?>/?artid=<?php echo ($vo["artid"]); ?>"><?php echo ($vo["arttitle"]); ?></a>
							</h4>
							<ul class="list-inline" style="color: #c0c0c0">
								...
								<li>
									<span class="fa fa-clock-o"></span><?php echo ($vo["artdate"]); ?>	
								</li>
							</ul>
                        <div class="blog-content"> <?php echo ($vo["artcontent"]); ?>
                        </div>
                        <!--<a class="btn btn-primary" href="<?php echo U('/Home/Blog/readMore');?>/?artid=<?php echo ($vo["artid"]); ?>">Read More <i-->
...
<div class=" bg-search">
    <form action="./" method="get">
        <div class="input-group">
            <input  id="keyword" name="keyword" name="member_mobile" required="" type="text" class="form-control" placeholder="请输入关键词">
            <div class="input-group-btn">
                <button type="submit" class="btn  no-shadow" tabindex="-1"><span class="fa fa-search"></span></button>
            </div> <!-- /input-group-btn -->
        </div>
    </form>
    <!-- /.input-group -->
    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="treelist">
                ...
                <?php if(is_array($cat)): $i = 0; $__LIST__ = $cat;if( count($__LIST__)==0 ) : echo "您还没设置分类" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="?catword=<?php echo ($vo["catname"]); ?>"><?php echo ($vo["catname"]); ?></a>
                </li><?php endforeach; endif; else: echo "您还没设置分类" ;endif; ?>
            </ul>

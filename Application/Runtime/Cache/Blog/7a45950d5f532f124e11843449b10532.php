...
<div class="container black-link-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 id="blog-home" class="page-header"><?php echo ($name); ?>'s Blog
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div  style="padding:10px;border-bottom:1px solid #f5f5f5;border-radius:5px;margin-bottom:20px">
							<h4>
								<a href="<?php echo U('/Blog/Index/readMore');?>/?artid=<?php echo ($vo["artid"]); ?>"><?php echo ($vo["arttitle"]); ?></a>
							</h4>

                ...
                <ul class="nav navbar-nav">
                    <?php if(empty($name)): ?><li><a href="<?php echo U('/Login/Index/index');?>">登录</a></li>
                        ...
                        <li>
                            ...
                            <a href="#"> <img class="head-icon-home" alt="<?php echo ($name); ?>" src="/Public/images/icon/<?php echo ($name); ?>.jpg"
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 service">
                ...
                <div class="center-block service-btn">
                    <p class="center">
                        <a class="btn btn-hire btn-primary" href="<?php echo U('/Home/Index/download');?>" role="button">去下载</a>
                    </p>
                </div>
...
<div id="portfolio">
    ...
    <div class="container">
        ...
        <div id="Grid" class="row gallery">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 images mix cat_php all">
                <div class="image">
                    <div class="overlay">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2 form">
                <!--FORM -->
                <form action="contact.php" class="form-horizontal" role="form" id="contactForm" method="post"
                      name="contactForm">
                    <?php if(empty($name)): ?><div class="form-group">

                            <div class="col-sm-12">
                                <input type="text" class="form-control input-lg" name="name" id="name" placeholder="敢不敢留下姓名！(′▽`〃)">
                                <!--<a href="">注册</a>-->
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control input-lg" rows="10" name="message" id="message"
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="bottom-con">
                    ...
                    <div class="">
                        ...
                        <p><a href="https://github.com/EchoWht"><i class="fa fa-weibo"><span> 昊_Tian</span></i></p>

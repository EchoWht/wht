    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group" style="height: 600px;overflow:auto;">
                <input type="hidden" id="tocodestyle" name="tocodestyle" value="">
                <input type="hidden" id="actionurl"  value="/index.php/User/Set/setstyle">

                <?php if(is_array($codestyle)): $i = 0; $__LIST__ = $codestyle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="javascript:void (0)" onclick="changeCodeStyle(this.id)" id="<?php echo ($vo["name"]); ?>"  class="list-group-item"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
